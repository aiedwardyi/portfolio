...
export const ko: Dictionary = {
  ...
  projects: {
    ...
    archon: {
      description:
        "프롬프트를 실제 프로덕션 애플리케이션으로 바꿔주는 멀티 에이전트 AI 플랫폼. 실시간 미리보기와 자동 평가 루프를 갖추고 있으며, Claude·GPT·Gemini·로컬 모델을 아우르는, 모델에 구애받지 않는 오케스트레이션을 지원합니다.",
      commitsLabel: "커밋",
    },
    stats: {
      yearsLabel: "개발 조직 운영",
    ...
    quorum: {
      description:
        "여러 AI 모델이 함께 토론하고 합의에 도달하는 그룹 채팅입니다. 구조화된 라운드를 거쳐 의견을 수렴합니다.",
    },
    pyithon: {
      description:
        "게임처럼 즐기는 Python 학습 플랫폼. 30단계로 구성된 점진적인 학습 과정, Pyodide 기반 브라우저 내 실제 코드 실행, AI 기반 평가까지. 설치 없이, 완전 무료.",
    },
    capabilities: [
      "멀티 에이전트 시스템",
      "LLM 오케스트레이션",
  ...
  about: {
    ...
    paragraphs: [
      [
        ...
        },
        {
          type: "text",
          value:
            ". 200개가 넘는 제품을 출시했고, 90명 이상의 개발 조직을 운영했으며, 직접 구축한 인프라를 기반으로 클라이언트들이 ",
        },
      ...
      [
        {
          type: "text",
          value:
            "개발 과정을 지속적으로 공개하고 있습니다. 실제로 출시되는 제품을 만드는 일에 관심이 있으시다면, ",
        },
    ...
    values: {
      ...
      tool: {
        title: "도구 제작자",
        description:
          "제가 만든 도구는 직접 겪은 문제에서 시작됩니다. 좋은 것들은 매일 쓰는 인프라가 됩니다.",
      },
      ownership: {
        title: "높은 주인의식",
        description:
  ...
  experience: {
    ...
    timeline: [
      ...
      },
      {
        ...
        description:
          "90명 이상 규모의 개발 조직을 운영하며 200개가 넘는 프로젝트를 출시했습니다. 파트너사들의 총 유치 자금 규모는 1억 6,700만 달러에 달하며, DeFi 프로토콜, 암호화폐 지갑, NFT 마켓플레이스, 데이터 스트리밍 인프라를 구축했습니다.",
      },
      {
        period: "2014 ~ 2017",
        role: "대표",
      ...
      },
      {
        period: "2003",
        role: "첫 서버 운영 · 14세",
        company: "Counter-Strike · 대학",
        description:
          "32인용 CS 모드 서버 두 대를 운영했고, 두 서버 모두 24시간 풀방이었습니다. 전용 서버를 임대하고, 데이터 센터를 직접 찾아가고, 슬롯 판매로 수익을 냈습니다. 같은 해에 대학에 입학했습니다.",
      },
    ],
  },
  contact: {
